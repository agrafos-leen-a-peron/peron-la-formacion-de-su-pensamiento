...
block-beta
    ...
    block:HEADER:6
        A["MOVIMIENTO"] B["NACIONALISMO ECONÓMICO"] C["JUSTICIA SOCIAL"] D["SINDICALISMO"] E["LIDERAZGO CARISMÁTICO"] F["TERCERA VÍA"]
    end
    
    block:PERONISMO:6
        G["PERONISMO<br/>(Argentina)"] H["✓ Nacionalizaciones<br/>✓ Industrialización<br/>✓ Mercado interno"] I["✓ Derechos trabajador<br/>✓ Redistribución<br/>✓ Bienestar social"] J["✓ CGT unificada<br/>✓ Participación política<br/>✓ Organización masiva"] K["✓ Perón-Eva<br/>✓ Conexión directa<br/>✓ Movilización popular"] L["✓ Ni capitalismo<br/>✓ Ni comunismo<br/>✓ Justicia social"]
    end
    
    block:VARGUISMO:6
        M["VARGUISMO<br/>(Brasil)"] N["✓ Petrobras<br/>✓ Siderurgia<br/>✓ Sustitución"] O["✓ CLT 1943<br/>✓ Salario mínimo<br/>✓ Seguridad social"] P["✓ Sindicatos oficiales<br/>✓ Contribución obligatoria<br/>✓ Control estatal"] Q["✓ Getúlio<br/>✓ 'Pai dos pobres'<br/>✓ Populismo"] R["✓ Estado Novo<br/>✓ Corporativismo<br/>✓ Desarrollo"]
    end
    
    block:CARDENISMO:6
        S["CARDENISMO<br/>(México)"] T["✓ Petróleo 1938<br/>✓ Ferrocarriles<br/>✓ Reforma agraria"] U["✓ Código trabajo<br/>✓ Educación socialista<br/>✓ Reparto tierras"] V["✓ CTM<br/>✓ Organización obrera<br/>✓ Sindicalismo revolucionario"] W["✓ Lázaro Cárdenas<br/>✓ Líder popular<br/>✓ Movilización masiva"] X["✓ Revolución institucional<br/>✓ Anti-imperialismo<br/>✓ Desarrollo nacional"]
    end
    
    block:APRA:6
        Y["APRA<br/>(Perú)"] Z["✓ Anti-imperialismo<br/>✓ Recursos nacionales<br/>✓ Indoamérica"] AA["✓ Programa social<br/>✓ Derechos laborales<br/>✓ Reforma agraria"] BB["✓ Organización obrera<br/>✓ Frente popular<br/>✓ Sindicalismo"] CC["✓ Haya de la Torre<br/>✓ Líder carismático<br/>✓ Exilio heroico"] DD["✓ Ni fascismo<br/>✓ ni comunismo<br/>✓ Democracia social"]
    end
    
    block:NASSER:6
        EE["NASSERISMO<br/>(Egipto)"] FF["✓ Nacionalización Suez<br/>✓ Socialismo árabe<br/>✓ Panarabismo"] GG["✓ Reforma agraria<br/>✓ Industrialización<br/>✓ Derechos trabajadores"] HH["✓ Sindicatos únicos<br/>✓ Organización popular<br/>✓ Movilización masas"] II["✓ Nasser<br/>✓ Líder panarabista<br/>✓ Carisma regional"] JJ["✓ No alineación<br/>✓ Socialismo árabe<br/>✓ Tercera vía"]
    end
    
    block:NEHRU:6
        KK["NEHRUVIANISMO<br/>(India)"] LL["✓ Planificación estatal<br/>✓ Sector público<br/>✓ Industrialización"] MM["✓ Socialismo democrático<br/>✓ Redistribución<br/>✓ Desarrollo rural"] NN["✓ Sindicatos oficiales<br/>✓ Congreso Nacional<br/>✓ Organización territorial"] OO["✓ Nehru<br/>✓ Líder intelectual<br/>✓ Prestigio internacional"] PP["✓ No alineación<br/>✓ Neutralismo<br/>✓ Tercer Mundo"]
    end
    
    block:SUKARNO:6
        QQ["SUKARNOISMO<br/>(Indonesia)"] RR["✓ Pancasila<br/>✓ Nacionalización<br/>✓ Economía dirigida"] SS["✓ Justicia social<br/>✓ Reforma agraria<br/>✓ Cooperativismo"] TT["✓ Organización popular<br/>✓ Frente nacional<br/>✓ Movilización masas"] UU["✓ Sukarno<br/>✓ 'Bung Karno'<br/>✓ Carisma nacional"] VV["✓ Nasakom<br/>✓ Síntesis ideológica<br/>✓ No alineación"]
    end
    
    block:KUOMINTANG:6
        WW["KUOMINTANG<br/>(China)"] XX["✓ Tres Principios Pueblo<br/>✓ Modernización dirigida<br/>✓ Industrialización"] YY["✓ Bienestar popular<br/>✓ Reforma agraria<br/>✓ Derechos trabajadores"] ZZ["✓ Partido único<br/>✓ Organización territorial<br/>✓ Disciplina militante"] AAA["✓ Sun Yat-sen<br/>✓ Chiang Kai-shek<br/>✓ Liderazgo nacional"] BBB["✓ Frente nacional-social<br/>✓ vs imperialismo<br/>✓ Tercera vía"]
    end
    
    block:JAPON:6
        CCC["MODELO JAPONÉS<br/>(Meiji)"] DDD["✓ Modernización acelerada<br/>✓ Industrialización dirigida<br/>✓ Estado desarrollista"] EEE["✓ Movilización nacional<br/>✓ Disciplina social<br/>✓ Sacrificio colectivo"] FFF["✓ Organización estatal<br/>✓ Burocracia eficiente<br/>✓ Planificación central"] GGG["✓ Emperador<br/>✓ Liderazgo simbólico<br/>✓ Unidad nacional"] HHH["✓ Nacionalismo<br/>✓ vs occidentalización<br/>✓ Autonomía tecnológica"]
    end
...
block-beta
    ...
    block:HEADER:11
        A["ASPECTO"] B["PERONISMO"] C["VARGUISMO"] D["CARDENISMO"] E["APRA"] F["NASSERISMO"] G["NEHRUVIANISMO"] H["SUKARNOISMO"] I["KUOMINTANG"] J["MODELO JAPONÉS"]
    end
    ...
    block:BASE_SOCIAL:11
        U["BASE<br/>SOCIAL"] V["Multiclasista amplia<br/>Obreros + clase media<br/>+ burguesía industrial"] W["Urbana limitada<br/>Trabajadores<br/>Burguesía débil"] X["Rural-campesina<br/>Ejidatarios<br/>Obreros limitados"] Y["Clase media<br/>Intelectuales<br/>Base restringida"] Z["Oficiales militares<br/>Trabajadores urbanos<br/>Campesinos limitados"] AA["Intelectuales<br/>Clase media urbana<br/>Base fragmentada"] BB["Intelectuales<br/>Militares nacionalistas<br/>Base rural dispersa"] CC["Militares + burgueses<br/>Campesinos<br/>Base fragmentada"] DD["Samurái + burgueses<br/>Campesinos<br/>Jerarquía rígida"]
    end
    
    block:ORGANIZACION:11
        EE["ORGANIZACIÓN<br/>POLÍTICA"] FF["Movimiento permanente<br/>Estructura territorial<br/>Institucionalización"] GG["Partido personalista<br/>Dependencia líder<br/>Fragmentación post-muerte"] HH["PRM burocratizado<br/>Institucionalización rígida<br/>Pérdida contenido"] II["Partido doctrinario<br/>Proscripción sistemática<br/>Sin acceso poder"] JJ["Partido único<br/>Dependencia líder<br/>Abandono sucesor"] KK["Congreso Nacional<br/>Fragmentación interna<br/>Declive gradual"] LL["Frente nacional<br/>Golpe militar<br/>Eliminación física"] MM["Partido único<br/>Guerra civil<br/>Exilio Taiwán"] NN["Sistema imperial<br/>Burocracia estatal<br/>Militarización extrema"]
    end
    
    block:DURACION:11
        OO["DURACIÓN<br/>HISTÓRICA"] PP["70+ años<br/>Permanencia excepcional<br/>Adaptación contextual"] QQ["30 años<br/>Interrupciones<br/>Declive 1990s"] RR["6 años<br/>Abandono sucesor<br/>Institucionalización PRI"] SS["Movimiento testimonial<br/>Sin poder real<br/>Fragmentación"] TT["18 años<br/>Abandono sucesor<br/>Declive panarabismo"] UU["17 años<br/>Fragmentación Congreso<br/>Liberalización 1991"] VV["22 años<br/>Eliminación violenta<br/>Dictadura militar"] WW["37 años China<br/>Derrota comunista<br/>Exilio Taiwán"] XX["77 años<br/>Derrota 1945<br/>Ocupación extranjera"]
    end
    
    block:CONTEXTO:11
        YY["CONTEXTO<br/>NACIONAL"] ZZ["Desarrollo avanzado<br/>Tradición democrática<br/>Recursos abundantes"] AAA["Fragmentación regional<br/>Autoritarismo<br/>Dependencia externa"] BBB["Post-revolución<br/>Inestabilidad<br/>Presión estadounidense"] CCC["Oligarquía rígida<br/>Exclusión social<br/>Represión sistemática"] DDD["Economía agraria<br/>Conflictos regionales<br/>Dependencia externa"] EEE["Fragmentación extrema<br/>Sistema castas<br/>Pobreza masiva"] FFF["Fragmentación territorial<br/>Diversidad étnica<br/>Economía colonial"] GGG["Guerra civil<br/>Invasión extranjera<br/>Fragmentación territorial"] HHH["Aislamiento insular<br/>Militarización extrema<br/>Recursos limitados"]
    end
...
```mermaid
timeline
    title Nacionalismos Populares Latinoamericanos: Cronología Comparada
    
    1920-1925 : PRECURSORES MUNDIALES
              : APRA Fundación (1924)
              : Haya de la Torre exilio
              : "Por la emancipación de América Latina"
              : Kuomintang China: Sun Yat-sen
              : Modelo "frente nacional-social"
              : Primera formulación antiimperialista
    
    1925-1930 : GESTACIÓN MUNDIAL
              : Revolución 1930 Brasil
              : Getúlio Vargas al poder
              : Chiang Kai-shek Kuomintang (1928)
              : Unificación China nacionalista
              : Sarobe agregado militar Japón
              : Observación modelo japonés
              : Crisis mundial 1929
              : Cuestionamiento liberalismo
    
    1930-1935 : PRIMERAS EXPERIENCIAS MUNDIALES
              : Estado Novo Brasil (1930)
              : Vargas consolidación
              : Kuomintang vs Comunistas China
              : Guerra civil china
              : Bolivia: Generales Toro-Busch (1936)
              : "Socialismo militar"
              : Argentina: Revolución 1930
              : Perón formación inicial
              : Sarobe transmisión experiencias
    
    1935-1940 : APOGEO CARDENISTA
              : Cárdenas Presidente México (1934-1940)
              : Nacionalización petróleo (1938)
              : Reforma agraria masiva
              : Educación socialista
              : Modelo para otros países
    
    1940-1945 : CONSOLIDACIÓN Y CRISIS ASIÁTICA
              : Estado Novo autoritario (1937-1945)
              : CLT Brasil (1943)
              : Legislación laboral avanzada
              : Corporativismo estatal
              : Invasión japonesa China (1937-1945)
              : Kuomintang vs Japón vs Comunistas
              : Argentina: Perón Secretario Trabajo (1943)
              : Síntesis experiencias asiáticas vía Sarobe
    
    1945-1950 : APOGEO PERONISTA Y NUEVOS NACIONALISMOS
              : Perón Presidente Argentina (1946)
              : Constitución 1949
              : Derechos del Trabajador
              : CGT unificada
              : Independencia India: Nehru (1947)
              : Independencia Indonesia: Sukarno (1945)
              : Modelo peronista más completo
    
    1950-1955 : CRISIS Y NUEVOS NACIONALISMOS
              : Revolución Oficiales Libres Egipto (1952)
              : Nasser al poder
              : Suicidio Vargas (1954)
              : Fin varguismo clásico
              : Golpe Perón (1955)
              : Exilio argentino
              : APRA proscripto Perú
              : Nacionalización Suez (1956)
    
    1955-1960 : FRAGMENTACIÓN
              : Brasil: PTB sin Vargas
              : México: PRI institucionalizado
              : Perú: APRA moderado
              : Argentina: Resistencia peronista
    
    1960-1970 : APOGEO Y CRISIS AFROASIÁTICOS
              : Conferencia Bandung (1955)
              : Movimiento No Alineados
              : Nasser apogeo panarabista
              : Nehru consolidación india
              : Sukarno "Democracia Dirigida"
              : Derrota árabe 1967
              : Muerte Nehru (1964)
              : Golpe Suharto Indonesia (1965)
              : Velasco Alvarado Perú (1968)
              : "Revolución peruana"
              : Influencia peronista
    
    1970-1980 : RETORNO Y ADAPTACIÓN
              : Perón regreso Argentina (1973)
              : Actualización doctrinaria
              : Muerte Nasser (1970)
              : Fin nasserismo clásico
              : Peronismo supervivencia única
```
...
```mermaid
flowchart TD
    subgraph "APRA PERUANO (1924-1945)"
        APRA_CONC["Conceptos APRA<br/>Haya de la Torre"]
        ANTI_IMP["Antiimperialismo<br/>Soberanía nacional<br/>Recursos propios"]
        FRENTE_NAC["Frente Nacional-Social<br/>vs círculos oligárquicos<br/>Alianza multiclasista"]
        ORG_POP["Organización Popular<br/>Partido de masas<br/>Participación ampliada"]
    end
    
    subgraph "VARGUISMO BRASILEÑO (1930-1954)"
        VARGAS_CONC["Conceptos Varguismo<br/>Getúlio Vargas"]
        SIND_EST["Sindicalismo Para-Estatal<br/>Control + autonomía<br/>Colaboración social"]
        MOVIMIENTO["Movimiento vs Partido<br/>Organización permanente<br/>Lealtad institucional"]
        LEG_LAB["Legislación Laboral<br/>CLT 1943<br/>Derechos trabajadores"]
    end
    
    subgraph "CARDENISMO MEXICANO (1934-1940)"
        CARD_CONC["Conceptos Cardenismo<br/>Lázaro Cárdenas"]
        VERD_DEM["Verdadera Democracia<br/>Social + económica<br/>No solo política"]
        NAC_REC["Nacionalización Recursos<br/>Petróleo 1938<br/>Soberanía energética"]
        JUST_SOC["Justicia Social<br/>Redistribución<br/>Reforma estructural"]
    end
    
    subgraph "MEDIADORES DOCUMENTADOS"
        SEOANE["Manuel Seoane<br/>Representante APRA<br/>Argentina"]
        SAROBE["José María Sarobe<br/>Correspondencia<br/>Vargas-Perón"]
        DEL_CARRIL["Hugo del Carril<br/>Correspondencia<br/>Ávila Camacho-Perón"]
    end
    
    subgraph "SÍNTESIS PERONISTA"
        PERON_SINT["Perón Sintetizador<br/>1943-1949"]
        V1["Verdad 1<br/>Verdadera Democracia"]
        V2["Verdad 2<br/>Esencialmente Popular"]
        V3["Verdad 3<br/>Trabajo para Movimiento"]
        TERCERA["Tercera Posición<br/>Internacional"]
    end
    
    APRA_CONC --> ANTI_IMP
    APRA_CONC --> FRENTE_NAC
    APRA_CONC --> ORG_POP
    
    VARGAS_CONC --> SIND_EST
    VARGAS_CONC --> MOVIMIENTO
    VARGAS_CONC --> LEG_LAB
    ...
    classDef apra fill:#e74c3c,color:#fff,stroke:#c0392b,stroke-width:2px
    classDef vargas fill:#f39c12,color:#fff,stroke:#e67e22,stroke-width:2px
    classDef cardenas fill:#27ae60,color:#fff,stroke:#229954,stroke-width:2px
    classDef mediadores fill:#8e44ad,color:#fff,stroke:#7d3c98,stroke-width:2px
    classDef peron fill:#2980b9,color:#fff,stroke:#1f618d,stroke-width:3px
    
    class APRA_CONC,ANTI_IMP,FRENTE_NAC,ORG_POP apra
    class VARGAS_CONC,SIND_EST,MOVIMIENTO,LEG_LAB vargas
    class CARD_CONC,VERD_DEM,NAC_REC,JUST_SOC cardenas
    class SEOANE,SAROBE,DEL_CARRIL mediadores
...
```mermaid
graph TD
    subgraph "RECEPCIÓN (1940-1943)"
        REC_APRA["Conceptos APRA<br/>vía Seoane<br/>Antiimperialismo"]
        REC_VARGAS["Conceptos Varguismo<br/>vía Sarobe<br/>Sindicalismo estatal"]
        REC_CARD["Conceptos Cardenismo<br/>vía del Carril<br/>Verdadera democracia"]
    end
    
    subgraph "ANÁLISIS (1943-1944)"
        ANAL_CONT["Análisis Contextual<br/>Realidad argentina<br/>Condiciones específicas"]
        ANAL_COMP["Análisis Comparativo<br/>Éxitos y fracasos<br/>Limitaciones otros"]
        ANAL_ADAPT["Análisis Adaptativo<br/>Qué funciona<br/>Qué modificar"]
    end
    
    subgraph "SÍNTESIS (1944-1946)"
        SINT_DIAL["Síntesis Dialéctica<br/>Integración creativa<br/>No copia mecánica"]
        SINT_ORIG["Originalidad<br/>Conceptos nuevos<br/>Adaptación argentina"]
        SINT_PRACT["Aplicación Práctica<br/>Políticas concretas<br/>Institucionalización"]
    end
    
    subgraph "RESULTADOS (1946-1955)"
        RES_V1["Verdad 1<br/>Verdadera Democracia<br/>(Cárdenas adaptado)"]
        RES_V2["Verdad 2<br/>Esencialmente Popular<br/>(APRA adaptado)"]
        RES_V3["Verdad 3<br/>Trabajo Movimiento<br/>(Vargas adaptado)"]
        RES_TERC["Tercera Posición<br/>Síntesis antiimperialista<br/>(APRA + contexto)"]
    end
    
    REC_APRA --> ANAL_CONT
    REC_VARGAS --> ANAL_COMP
    REC_CARD --> ANAL_ADAPT
    
    ANAL_CONT --> SINT_DIAL
    ANAL_COMP --> SINT_ORIG
    ANAL_ADAPT --> SINT_PRACT
    ...
    classDef recepcion fill:#3498db,color:#fff,stroke:#2980b9,stroke-width:2px
    classDef analisis fill:#f39c12,color:#fff,stroke:#e67e22,stroke-width:2px
    classDef sintesis fill:#e74c3c,color:#fff,stroke:#c0392b,stroke-width:2px
    classDef resultados fill:#27ae60,color:#fff,stroke:#229954,stroke-width:2px
    
    class REC_APRA,REC_VARGAS,REC_CARD recepcion
    class ANAL_CONT,ANAL_COMP,ANAL_ADAPT analisis
    class SINT_DIAL,SINT_ORIG,SINT_PRACT sintesis
    class RES_V1,RES_V2,RES_V3,RES_TERC resultados
```
...
```mermaid
gantt
    title Influencias Cronológicas en la Formación de Perón (1920-1950)
    dateFormat YYYY
    axisFormat %Y
    
    section Precursores
    APRA Fundación (Haya)          :1924, 1930
    Revolución Mexicana (antecedente) :1917, 1925
    
    section Contemporáneos Tempranos
    Varguismo Brasil (Sarobe mediador) :1930, 1945
    Cardenismo México (del Carril mediador) :1934, 1940
    Bolivia Toro-Busch (contactos) :1936, 1939
    
    section Formación Peronista
    Perón Secretario Trabajo :1943, 1946
    Síntesis conceptual :1943, 1949
    
    section Consolidación
    Presidencia Perón :1946, 1955
    Constitución 1949 :1949, 1949
    Doctrina sistematizada :1949, 1955
    
    section Declive Otros
    Fin Cardenismo :1940, 1940
    Suicidio Vargas :1954, 1954
    APRA moderación :1945, 1960
```
...
block-beta
    ...
    block:HEADER:8
        A["PAÍS"] B["LÍDER"] C["PERÍODO"] D["BASE SOCIAL"] E["CONTEXTO ECONÓMICO"] F["OPOSICIÓN"] G["RESULTADO"] H["PERMANENCIA"]
    end
    
    block:ARGENTINA:8
        I["ARGENTINA"] J["Juan D. Perón"] K["1946-1955<br/>1973-1976"] L["Clase obrera urbana<br/>+ Clase media<br/>+ Burguesía industrial"] M["Industrialización avanzada<br/>Mercado interno<br/>Recursos abundantes"] N["Oligarquía debilitada<br/>Oposición fragmentada<br/>Presión externa limitada"] O["ÉXITO COMPLETO<br/>Transformación estructural<br/>Institucionalización"] P["70+ años<br/>Movimiento vigente<br/>Permanencia excepcional"]
    end
    
    block:BRASIL:8
        Q["BRASIL"] R["Getúlio Vargas"] S["1930-1945<br/>1951-1954"] T["Trabajadores urbanos<br/>Limitada clase media<br/>Burguesía débil"] U["Industrialización inicial<br/>Economía regional<br/>Dependencia externa"] V["Oligarquías regionales<br/>Militares pro-USA<br/>Presión estadounidense"] W["ÉXITO LIMITADO<br/>Legislación laboral<br/>Suicidio 1954"] X["30 años<br/>Interrupciones<br/>Declive 1990s"]
    end
    
    block:MEXICO:8
        Y["MÉXICO"] Z["Lázaro Cárdenas"] AA["1934-1940"] BB["Campesinos<br/>Trabajadores urbanos<br/>Sectores medios"] CC["Economía devastada<br/>Reconstrucción<br/>Dependencia USA"] DD["Iglesia católica<br/>Empresarios<br/>Presión externa"] EE["ÉXITO BREVE<br/>Nacionalización petróleo<br/>Abandono sucesor"] FF["6 años<br/>Institucionalización PRI<br/>Pérdida contenido"]
    end
    
    block:PERU:8
        GG["PERÚ"] HH["Haya de la Torre"] II["1924-1980"] JJ["Clase media<br/>Trabajadores urbanos<br/>Limitada base"] KK["Economía oligárquica<br/>Mono-exportadora<br/>Control externo"] LL["Oligarquía férrea<br/>Militares represivos<br/>Proscripción sistemática"] MM["FRACASO<br/>Nunca en poder<br/>Movimiento testimonial"] NN["Movimiento fragmentado<br/>Sin poder real<br/>Irrelevancia política"]
    end
    
    block:EGIPTO:8
        OO["EGIPTO"] PP["Gamal A. Nasser"] QQ["1952-1970"] RR["Oficiales militares<br/>Trabajadores urbanos<br/>Campesinos limitados"] SS["Economía agraria<br/>Dependencia algodón<br/>Pobreza extrema"] TT["Hermanos Musulmanes<br/>Potencias occidentales<br/>Israel-conflictos"] UU["ÉXITO LIMITADO<br/>Nacionalización Suez<br/>Derrota 1967"] VV["18 años<br/>Abandono sucesor<br/>Declive panarabismo"]
    end
    
    block:INDIA:8
        WW["INDIA"] XX["Jawaharlal Nehru"] YY["1947-1964"] ZZ["Intelectuales<br/>Clase media urbana<br/>Campesinos limitados"] AAA["Economía colonial<br/>Pobreza masiva<br/>Fragmentación"] BBB["Sistema castas<br/>Separatismos<br/>Conflictos fronterizos"] CCC["ÉXITO INSTITUCIONAL<br/>Democracia estable<br/>Derrota China 1962"] DDD["17 años<br/>Fragmentación Congreso<br/>Liberalización 1991"]
    end
    
    block:INDONESIA:8
        EEE["INDONESIA"] FFF["Sukarno"] GGG["1945-1967"] HHH["Intelectuales<br/>Militares nacionalistas<br/>Base rural limitada"] III["Economía colonial<br/>Fragmentación extrema<br/>Pobreza absoluta"] JJJ["Militares pro-occidentales<br/>Fragmentación étnica<br/>Presión CIA"] KKK["FRACASO VIOLENTO<br/>Golpe militar 1965<br/>Genocidio masivo"] LLL["22 años<br/>Eliminación física<br/>Dictadura Suharto"]
    end
    
    block:CHINA:8
        MMM["CHINA"] NNN["Sun Yat-sen<br/>Chiang Kai-shek"] OOO["1912-1949"] PPP["Militares + burgueses<br/>Campesinos<br/>Intelectuales limitados"] QQQ["Economía agraria<br/>Guerra civil<br/>Invasión japonesa"] RRR["Comunistas<br/>Señores guerra<br/>Invasión extranjera"] SSS["FRACASO CONTINENTAL<br/>Derrota comunista<br/>Exilio Taiwán"] TTT["37 años China<br/>Dictadura Taiwán<br/>Democratización tardía"]
    end
    
    block:JAPON:8
        UUU["JAPÓN"] VVV["Emperador Meiji<br/>Oligarquía militar"] WWW["1868-1945"] XXX["Samurái + zaibatsu<br/>Campesinos<br/>Jerarquía rígida"] YYY["Industrialización acelerada<br/>Militarización<br/>Imperialismo"] ZZZ["Potencias occidentales<br/>Resistencia interna<br/>Guerra mundial"] AAAA["FRACASO MILITARISTA<br/>Derrota 1945<br/>Ocupación extranjera"] BBBB["77 años<br/>Desmilitarización<br/>Democracia impuesta"]
    end
